...
describe('scaleImage', () => {
  ...
  test('increase size', () => {
    ...
    const scaledImageData = scaleImage(imageData, newWidth, newHeight, nearestNeighbor)
  ...
  test('empty input image', () => {
    ...
    const scaledImageData = scaleImage(emptyImageData, newWidth, newHeight, nearestNeighbor)
